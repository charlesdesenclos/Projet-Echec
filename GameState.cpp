...
int GameState::PionB(int ox, int oy, int nx, int ny)
{
	if (ancienPos.y == 6)
	{
...
int GameState::PionN(int ox, int oy, int nx, int ny)
{
	if (ancienPos.y == 1)
	{
		if ((ny == oy + 1 && nx == ox && board[oy + 1][ox] == 0) || (ny == oy + 2 && nx == ox && board[oy + 1][ox] == 0 && board[oy + 2][ox] == 0))
...
int GameState::TourB(int ox, int oy, int nx, int ny)
{
...
int GameState::TourN(int ox, int oy, int nx, int ny)
{
	for (int i = ox - 1; i >= 0; i--) // À gauche
	{
		if (board[oy][i] <= 0 && (nx == i && ny == oy))
...
int GameState::FouB(int ox, int oy, int nx, int ny)
{
	int j = ox - 1;
...
int GameState::FouN(int ox, int oy, int nx, int ny)
{
	int j = ox - 1;
	for (int i = oy - 1; i >= 0; i--) // en haut à gauche
	{
...
int GameState::ReineB(int ox, int oy, int nx, int ny)
{
	for (int i = ox - 1; i >= 0; i--) // À gauche
	{
		if (board[oy][i] >= 0 && (nx == i && ny == oy))
...
int GameState::ReineN(int ox, int oy, int nx, int ny)
{
	for (int i = ox - 1; i >= 0; i--) // À gauche
	{
		if (board[oy][i] <= 0 && (nx == i && ny == oy))
...
int GameState::ChevalB(int ox, int oy, int nx, int ny)
{
...
int GameState::ChevalN(int ox, int oy, int nx, int ny)
{
	if (oy - 2 >= 0 && ox - 1 >= 0 && ny == oy - 2 && nx == ox - 1 && board[ny][nx] <= 0)
	{
		return 1; // en haut à gauche
...
int GameState::PionBJeuxEchecs(int posx, int posy, int roix, int roiy)
{
...
int GameState::TourBJeuxEchecs(int ox, int oy, int roix, int roiy)
{
	for (int i = ox - 1; i >= 0; i--) // À gauche
	{
...
int GameState::FouBJeuxEchecs(int ox, int oy, int roix, int roiy)
{
	int j = ox - 1;
	for (int i = oy - 1; i >= 0; i--) // en haut à gauche
	{
...
int GameState::ReinneBJeuxEchecs(int ox, int oy, int roix, int roiy)
{
	for (int i = ox - 1; i >= 0; i--) // À gauche
	{
		if (board[oy][i] >= 0 && (roix == i && roiy == oy))
...
int GameState::ChevalBJeuxEchecs(int ox, int oy, int roix, int roiy)
{
...
int GameState::RoiBJeuxEchecs(int ox, int oy, int roix, int roiy)
{
...
int GameState::PionNJeuxEchecs(int ox, int oy, int roix, int roiy)
{
	if (board[oy + 1][ox - 1] <= 0)
	{
...
int GameState::TourNJeuxEchecs(int ox, int oy, int roix, int roiy)
{
	for (int i = ox - 1; i >= 0; i--) // À gauche
	{
		if (board[oy][i] <= 0 && (roix == i && roiy == oy))
...
int GameState::FouNJeuxEchecs(int ox, int oy, int roix, int roiy)
{
	int j = ox - 1;
	for (int i = oy - 1; i >= 0; i--) // en haut à gauche
	{
...
int GameState::ReinneNJeuxEchecs(int ox, int oy, int roix, int roiy)
{
	for (int i = ox - 1; i >= 0; i--) // À gauche
	{
		if (board[oy][i] <= 0 && (roix == i && roiy == oy))
...
int GameState::ChevalNJeuxEchecs(int ox, int oy, int roix, int roiy)
{
	if (oy - 2 >= 0 && ox - 1 >= 0 && roiy == oy - 2 && roix == ox - 1 && board[roiy][roix] <= 0)
	{
		return 1; // en haut à gauche
...
int GameState::RoiNJeuxEchecs(int ox, int oy, int roix, int roiy)
{
	if (ox - 1 >= 0 && oy - 1 >= 0 && roiy == oy - 1 && roix == ox - 1 && board[roiy][roix] >= 0)
	{
		return 1;
...
int GameState::RoiNoirJeuxEchecsVerif(int posRoix, int posRoiy)
{
	int ok = 0;
...
int GameState::RoiN(int ox, int oy, int nx, int ny)
{
...
int GameState::RoiBlancJeuxEchecsVerif(int posRoix, int posRoiy)
{
	int ok = 0;
	for (int i = 0; i < LONGUEUR; i++)
	{
...
int GameState::RoiB(int ox, int oy, int nx, int ny)
{
	if (ox - 1 >= 0 && oy - 1 >= 0 && ny == oy - 1 && nx == ox - 1 && board[ny][nx] >= 0)
	{
